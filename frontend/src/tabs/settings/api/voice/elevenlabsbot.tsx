...
export const ElevenLabsBot = () => {
    ...
    const { elevenLabsBotBalance, refreshElevenLabsBotBalance, loadingElevenLabsBot } = useServices();
                ...
                <div className="settings-section">
                    ...
                    <div style={{ display: 'flex', flexDirection: 'column', gap: '5px' }}>
                        <div style={{ display: 'flex', gap: '10px' }}>
                            ...
                            >
                                {loadingElevenLabsBot ? '...' : t('settings.voice.fetchBalance')}
                            </button>
                        </div>
                        ...
                        <div style={{ minHeight: '20px', display: 'flex', justifyContent: 'flex-end', alignItems: 'center' }}>
                            <span style={{ color: '#4caf50', fontWeight: 'bold', fontSize: '1.1em', marginRight: '10px' }}>
                                {t('settings.voice.balance')} {elevenLabsBotBalance !== null ? elevenLabsBotBalance.toLocaleString() : '---'}
                            </span>
                            {statusMsg && (
                                <span style={{
