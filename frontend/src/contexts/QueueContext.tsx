    ...
    const addTask = useCallback((type: any, content: string, settings: any, name?: string, subName?: string, skippedStages?: string[], existingData?: any, taskId?: string, taskNumber?: number) => {
        ...
        const newTask: QueueTask = {
            ...
            settings: {
                ...
                subtitleEnabled: effectiveSkip?.includes('subtitle') ? (settings.subtitleEnabled ?? true) : settings.subtitleEnabled,
        ...
        const newItems: QueueTask[] = tasksData.map((d, i) => {
            ...
            return {
                ...
                settings: {
                    ...
                    subtitleEnabled: effectiveSkip?.includes('subtitle') ? (d.settings.subtitleEnabled ?? true) : d.settings.subtitleEnabled,
