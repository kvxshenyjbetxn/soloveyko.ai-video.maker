...
pub fn draw_storage_section(
    ...
    ui.vertical(|ui| {
        ...
        draw_path_row(ui, language, translate(language, "storage_path_macos"), save_path_macos, is_macos);
        ui.add_space(4.0);
        draw_path_row(ui, language, translate(language, "storage_path_windows"), save_path_windows, !is_macos);
...
fn draw_path_row(
    ...
    ui.horizontal(|ui| {
        ...
        if is_active {
            ui.label(
                egui::RichText::new(format!("{} {}", platform_label, translate(language, "storage_path_active")))
                    .strong(),
            );
        } else {
