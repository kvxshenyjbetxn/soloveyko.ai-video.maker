...
"api_key" => "API Ключ",
        ...
        "welcome_install_btn" => "↓ Установить",
        "welcome_recheck_btn" => "↺ Проверить снова",
        "welcome_copy_hint" => "Нажми чтобы скопировать",
        "welcome_npm_desc" => "npm / Node.js — необходим для установки Gemini CLI на Windows",
        "welcome_brew_desc" => "Homebrew — менеджер пакетов для macOS, необходим для установки других инструментов",
