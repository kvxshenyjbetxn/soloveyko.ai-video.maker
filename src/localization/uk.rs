...
pub fn translate_uk(key: &str) -> &'static str {
    match key {
        ...
        "agent_chat_continue_btn" => "Продовжити пайплайн",
        ...
        "queue_status_awaiting_agent" => "Очікує контролю агента",
...
"api_key" => "API Ключ",
        ...
        "video_agent_prompt_hint" => "{{srt}} — шлях до subtitle.srt (агент читає сам), {{path}} — шлях до timeline.json",
