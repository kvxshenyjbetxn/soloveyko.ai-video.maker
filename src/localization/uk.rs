...
pub fn translate_uk(key: &str) -> &'static str {
    match key {
        ...
        "montage_editor_regen_placeholders" => "Догенерувати плейсхолдери",
        "montage_editor_regen_placeholders_hint" => {
            "Згенерувати всі сегменти, які ще лишились плейсхолдерами"
        }
        ...
        "montage_hyperframes_generate_btn" => "Створити HyperFrames",
        "montage_hyperframes_generate_hint" => {
            "Запустити окремого агента для кожного HyperFrames-кліпу за його режисерським описом"
        }
        "montage_hyperframes_edit_btn" => "✎ Редагувати HyperFrames",
        ...
        "lumean_key_hint" => "Введіть X-API-Key...",
        "lumean_status_checking" => "⏳ Перевірка...",
        "lumean_key_required" => "⚠ Введіть ключ Lumean в секції АПІ",
        ...
        "settings_pi_threads" => "Макс. потоків Pi CLI",
        ...
        "queue_status_cancelled" => "Скасовано",
        ...
        "queue_error_no_lumean_key" => "⚠ Вкажіть Lumean ключ в секції АПІ",
        "queue_error_no_lumean_template" => "⚠ Оберіть шаблон Lumean для озвучення",
        ...
        "job_cancel_tooltip" => "Повністю зупинити задачу й убити пов'язані процеси",
        "queue_cancel_dialog_title" => "Зупинити задачу?",
        "queue_cancel_dialog_text" => {
            "Задача буде примусово зупинена, пов'язані процеси буде вбито, а сама задача зникне з черги."
        }
        "queue_cancel_dialog_keep_btn" => "Ні, залишити",
        "queue_cancel_dialog_confirm_btn" => "Так, зупинити",
        ...
        "welcome_pi_desc" => "Pi CLI — для агентних задач редагування та створення файлів",
        ...
        "balance_lumean_limit" => "Обмеження потоків: 5 (фіксовано)",
        ...
        "gallery_regen_batch_window_title" => "Пакетна перегенерація плейсхолдерів",
        ...
        "gallery_regen_batch_hint" => {
            "Для кожного плейсхолдера буде використано його збережений промт."
        }
        "gallery_regen_batch_start_btn" => "Догенерувати",
