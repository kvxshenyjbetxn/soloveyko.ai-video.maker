...
"api_key" => "API Ключ",
        ...
        "welcome_install_btn" => "↓ Встановити",
        "welcome_recheck_btn" => "↺ Перевірити знову",
        "welcome_copy_hint" => "Натисни щоб скопіювати",
        "welcome_npm_desc" => "npm / Node.js — необхідний для встановлення Gemini CLI на Windows",
        "welcome_brew_desc" => "Homebrew — менеджер пакетів для macOS, необхідний для встановлення інших інструментів",
