...
pub fn translate_en(key: &str) -> &'static str {
    match key {
        ...
        "montage_editor_timeline_track_height" => "Timeline track height",
        ...
        "lumean_key_hint" => "Enter X-API-Key...",
        "lumean_status_checking" => "⏳ Checking...",
        "lumean_key_required" => "⚠ Enter Lumean key in the API section",
        ...
        "queue_error_no_lumean_key" => "⚠ Enter the Lumean key in the API section",
        "queue_error_no_lumean_template" => "⚠ Select a Lumean voiceover template",
        ...
        "balance_lumean_limit" => "Threads limit: 5 (fixed)",
