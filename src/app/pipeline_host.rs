...
impl VideoMakerApp {
    ...
    pub(super) fn enqueue_from_history(
        ...
        let settings = crate::queue::JobSettings {
            ...
            magnific_key: t.magnific_key.clone(),
            ...
            egui::SidePanel::right("pipeline_panel")
                ...
                .show(ctx, |ui| {
                    crate::gui::pipeline::draw_pipeline_panel(
                        ...
                        &mut self.lumean_key,
                        &mut self.lumean_status,
                        &self.lumean_test_result,
                        &self.lumean_balance,
                        ...
                        &mut self.magnific_key,
                        &mut self.magnific_status,
                        &self.magnific_test_result,
