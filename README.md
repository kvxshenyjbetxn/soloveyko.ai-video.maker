...
│   │   ├── types.rs             — константи (FRAME_CACHE_SIZE=80) + типи: PreviewQuality (Performance/Balanced/High/Ultra), PreviewRenderSettings (якість+FPS превʼю), ClipKind, DragMode, EditorClip, MontagePreviewSettings, MontageEditorActions (animate_paths + regen_action + open_stock_picker + preview_render_changed), ClipDragState, PreviewDragMode, PreviewDragState; `EditorClip.stock_seg_idx: Option<usize>` — індекс у `stock_cache.json`
