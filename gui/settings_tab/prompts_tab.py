...
class PromptsTab(QWidget):
    ...
    def retranslate_ui(self):
        ...
        self.preview_model_label.setText(translator.translate("preview_model_label"))
        self.preview_tokens_label.setText(translator.translate("preview_tokens_label"))
        self.preview_temp_label.setText(translator.translate("preview_temp_label"))
        ...
        self.preview_provider_label.setText(translator.translate("preview_image_provider_label"))
        self.preview_provider_help.update_tooltip()
        self.preview_poll_model_label.setText(translator.translate("preview_pollinations_model_label"))
