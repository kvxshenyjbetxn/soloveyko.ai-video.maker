...
- [[_COMMUNITY_Gallery Video Player|Gallery Video Player]]
...
7. `FrameCache` - 27 edges
8. `MontageEditorState` - 26 edges
...
- 1-file cycle: `src/gui/montage_editor/inspector.rs -> src/gui/montage_editor/inspector.rs`
...
Cohesion: 0.08
Nodes (21): ClipDragState, ClipKind, DragMode, EditorClip, MontageEditorActions, MontagePreviewSettings, OpacityDragState, PreviewDragMode (+13 more)
...
### Community 27 - "Gallery Video Player"
Cohesion: 0.26
...
Cohesion: 0.18
Nodes (17): draw_montage_editor_window(), draw_montage_media_preview(), load_preview_texture(), MontageEditorActions, Arc, Context, HashSet, Language (+9 more)
...
Cohesion: 0.26
Nodes (12): draw_timeline(), update_clip_drag(), update_opacity_drag(), Arc, Context, HashSet, Language, MontageEditorState (+4 more)

### Community 43 - "Montage Montage"
Cohesion: 0.24
Nodes (12): build_image_filter_parts(), find_voice_file(), pick_transition(), run_montage(), Fn, Option, OverlayTrigger, Path (+4 more)
...
Cohesion: 0.24
Nodes (8): AudioPlayer, PlayingAudio, OutputStream, Sink, Option, Path, PathBuf, Self
...
Cohesion: 0.52
Nodes (6): draw_preview_settings(), draw_topbar(), Language, MontageEditorState, PipelineJob, Ui
