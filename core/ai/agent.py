    ...
    def __init__(self, api_key: str, model: str = "openai/gpt-4o-mini"):
        ...
        self.messages: List[Dict[str, str]] = [
            {"role": "system", "content": (
                ...
                "Якщо мова йде про якість зображень, ти можеш запропонувати змінити провайдера (наприклад, на 'pollinations', 'googler' або 'elevenlabs_image'). "
                "ВАЖЛИВО: Перед зміною будь-яких налаштувань (виклик інструментів), ти ПОВИНЕН запитати дозволу у користувача.\n\n"
                f"{APP_CONTEXT}"
            )}
        ]
