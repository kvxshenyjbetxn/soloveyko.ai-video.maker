...
- налаштування програми та апі сервісів знаходяться модульно в /src/gui/settings, там все модульно, дотримуйся модульності при додаванні нових вкладок або налаштувань.